...
My repositories are a graveyard for projects from when I was learning to code in undergrad. It is unmaintained, unpolished, and largely abandoned. I use GitLab for large deployment projects and this for smaller(ish) tools or non-deployment tools.
...
### Access
If you actually need code, files, or details regarding portfolio material, **request me personally**.
